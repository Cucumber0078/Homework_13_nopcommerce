...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"),"Prime");
        sendTextElement(By.xpath("//input[@id='BillingNewAddress_LastName']"),"Testing");

        Random ran = new Random();
        int emailNum = ran.nextInt(9999);
        sendTextElement(By.id("BillingNewAddress_Email"), "ram.lax"+emailNum+"@gmail.com" );
