...
public class ElectronicTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextElement(By.xpath("//input[@id='FirstName']"),"Prime");
        sendTextElement(By.xpath("//input[@id='LastName']"),"Testing");

        Random ran = new Random();
        int emailNum = ran.nextInt(9999);
        sendTextElement(By.id("Email"), "ram.lax"+emailNum+"@gmail.com" );
        sendTextElement(By.xpath("//input[@id='Password']"),"asdfgh");
        sendTextElement(By.xpath("//input[@id='ConfirmPassword']"),"asdfgh");
        ...
        sendTextElement(By.xpath("//input[@id='BillingNewAddress_City']"),"London");
        sendTextElement(By.xpath("//input[@id='BillingNewAddress_Address1']"),"50 Brent Road");
        sendTextElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"),"HA0 1AB");
        sendTextElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"),"071234567891");
        ...
        sendTextElement(By.xpath("//input[@id='CardholderName']"),"Mr A Smith");
        sendTextElement(By.xpath("//input[@id='CardNumber']"),"5244301009707149");
        selectByValue(By.xpath("//select[@id='ExpireMonth']"),"4");
        selectByValue(By.xpath("//select[@id='ExpireYear']"),"2028");
        sendTextElement(By.xpath("//input[@id='CardCode']"),"808");
